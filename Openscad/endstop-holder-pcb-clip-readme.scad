...
difference(){
	...
	translate([-4-switch_add, 17, 5]) rotate([90, 0, 0]) cylinder(h =20, r = switch_screw_hole_radius, $fn = 10);
	translate([-(4+switch_add+screw_hole_spacing), 17, 5]) rotate([90, 0, 0]) cylinder(h =20, r = switch_screw_hole_radius, $fn = 10);
}
}
endstop();
