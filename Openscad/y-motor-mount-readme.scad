...
translate([-3.81,21.59,-5]) cylinder(h=50,r=m3_diameter/2,$fn=20) ;
translate([-3.81,21.59,5]) cylinder(h=50,r=3.2) ;
translate([-21.59,-3.81,-5]) cylinder(h=50,r=m3_diameter/2,$fn=20) ;
translate([-21.59,-3.81,5]) cylinder(h=50,r=3.2) ;
translate([3.81,-21.59,-5]) cylinder(h=50,r=m3_diameter/2,$fn=20) ;
translate([21.59,3.81,-5]) cylinder(h=50,r=m3_diameter/2,$fn=20) ;
translate([-33.81,8.20,-5]) cylinder(h=50,r=m3_diameter/2,$fn=20) ;
...
union() {
translate([-20.85,30.70,-5]) cylinder(h=30,r=4.50,$fn=20) ;
...
translate([-20,-30,-5]) cylinder(h=30,r=15, center=true, $fn=40) ;
translate([3.81,-21.59,-5]) cylinder(h=100,r=m3_diameter/2,$fn=20) ;
translate([21.59,3.81,-5]) cylinder(h=100,r=m3_diameter/2,$fn=20) ;
translate([-33.81,8.20,-5]) cylinder(h=50,r=m3_diameter/2,$fn=20) ;

translate([-3.81,21.59,-5]) cylinder(h=50,r=m3_diameter,$fn=20) ;
translate([-21.59,-3.81,-5]) cylinder(h=50,r=m3_diameter,$fn=20) ;
